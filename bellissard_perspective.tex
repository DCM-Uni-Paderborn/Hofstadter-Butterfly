...
The source of this article, the bilayer model code and eigenvalue files, the spectral-moment analysis, and the refined butterfly and state-count data are available in \url{https://github.com/DCM-Uni-Paderborn/Hofstadter-Butterfly}. The reproduction scripts in the \texttt{analysis/} directory are \texttt{bellissard\_model\_moments.py} for Fig.~\ref{fig:moments} and \texttt{bellissard\_butterfly.py} for Fig.~\ref{fig:butterfly}.
